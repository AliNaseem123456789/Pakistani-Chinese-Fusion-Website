...
export function MenuPage() {
  ...
  const menuItems = {
    ...
    appetizers: [
      ...
      { name: 'Chicken Wonton (5 pcs)', desc: 'Crispy chicken wontons', price: '$6.99', image: MenuImages.Chicken_Wontons },
    ...
    drinks: [
      { name: 'Lassi', desc: 'Refreshing yogurt drink', price: '$4.49', image: MenuImages.Mango_Lassi },
      ...
      <div className="bg-white">
        ...
        {sidebarOpen && (
          <div className="fixed inset-0 z-50 md:hidden">
            ...
            />
            <div className="relative w-64 h-full bg-white p-6 shadow-xl">
              <button
